...
const standardPath = "STACK_RELEASE_CANDIDATE/INVOCORDER_STACK_RELEASE_CANDIDATE_STANDARD.json";
const receiptPath = "STACK_RELEASE_CANDIDATE/INVOCORDER_STACK_RELEASE_CANDIDATE_RECEIPT.json";
const label = "STACK_RELEASE_CANDIDATE";
